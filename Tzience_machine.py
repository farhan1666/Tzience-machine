...
class Ui_TzienceMachine(object):
    def setupUi(self, TzienceMachine):
        ...
        self.simCount.setMaximum(1000000000)
        ...
        self.noSetLine.setObjectName("lineEdit")
        ...
        self.action_Hai_credit = QtWidgets.QAction(TzienceMachine)
        self.action_Hai_credit.setObjectName("action_Hai_credit")
        ...
        self.menuCredits.addAction(self.action_Hai_credit)
    ...
    def retranslateUi(self, TzienceMachine):
        ...
        self.noSetLine.setText(_translate("TzienceMachine", "Total no set Zuks: x"))
        ...
        self.action_Hai_credit.setText(_translate("TzienceMachine", "@haiyoart - Application icon"))
